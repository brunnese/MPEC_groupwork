...
for l = 1:parNMPC.nRK4
    k1x = fxdot(xEnd + TRK4/2 *k1x, u);
    k2x = fxdot(xEnd + TRK4/6 * k1x + TRK4/2 * k2x, u);
    k3x = fxdot(xEnd - TRK4/2 * k1x + TRK4/2 * k2x + TRK4/2 * k3x, u);
    k4x = fxdot(xEnd + TRK4/2 * 3*k1x - TRK4/2 * 3*k2x + TRK4/2 * k3x + TRK4/2 * k4x, u);
   
    xEnd = xEnd + TRK4/2 * (3*k1x - 3*k2x + k3x + k4x);
...
qp_W        = Function('qp_W',{optVars,p},{W});
